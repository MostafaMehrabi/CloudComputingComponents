...
//			}			
	...
	public BufferedImage[] split() throws IOException {
		...
		String readFileName = "." + File.separator + "image" + File.separator + fileName;
	
		File imageFile = new File(readFileName + ".jpg");
		...
		System.out.println("main image size: " + mainImageWidth + " x " + mainImageHeight);
	...
	public BufferedImage join(BufferedImage[] images) {
		...
		System.out.println("joint image size: " + jointImageWidth + " x " + jointImageHeight);
