...
public class Main {
	...
	public static void main(String[] args) {
		...
		imageNames.add("image3.jpg"); imageNames.add("image5.jpg");
		imageNames.add("image1.jpg"); imageNames.add("image6.jpg");
		imageNames.add("image2.jpg"); imageNames.add("image4.jpg");
